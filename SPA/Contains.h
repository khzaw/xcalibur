...
public:
	...
	//vectorters
	static void insertProgProc(int,int); 
	static void insertProcStmtLst(int,int); 
	static void insertStmtLstStmt(int,int); 
	static void insertStmtVar(int,int);  
	static void insertStmtConst(int,int); 
	static void insertStmtPlus(int,int); 
	static void insertStmtMinus(int,int); 
	static void insertStmtTimes(int,int; 
	static void insertStmtStmtLst(int,int);  
	static void insertPlusVar(int,int); 
	static void insertPlusConst(int,int);
	static void insertMinusVar(int,int);
	static void insertMinusConst(int,int);
	static void insertTimesVar(int,int);
	static void insertTimesConst(int,int);
	static void insertPlusPlus(int,int);
	static void insertPlusMinus(int,int);
	static void insertPlusTimes(int,int);
	static void insertMinusTimes(int,int);
	static void insertMinusPlus(int,int);
	static void insertMinusMinus(int,int);
	static void insertTimesPlus (int,int); 
	static void insertTimesMinus(int,int); 
	static void insertTimesTimes(int,int); 

	//getters
	//for program ContainerStar
	static vector<int> getProcContainedInProg (int);  //returns the procedures Contained within a program
